#!/bin/bash
# refactor.sh - Refactorización modular de NEXUS CAD v21.2
# Ejecutar en ~/nexus_app

set -e  # Detener si hay error

echo "🚀 Iniciando refactorización modular de NEXUS CAD..."

# 1. Crear estructura de directorios
mkdir -p server core ui ui/tabs

# 2. Crear __init__.py vacíos
touch server/__init__.py core/__init__.py ui/__init__.py ui/tabs/__init__.py

# 3. Hacer backup del main.py original
cp main.py main.py.backup
echo "✅ Backup de main.py creado como main.py.backup"

# =======================================================
# 4. CREAR core/constants.py
# =======================================================
...
# =======================================================
# 5. CREAR core/state.py (Singleton)
# =======================================================
...
# =======================================================
# 6. CREAR core/system_utils.py
# =======================================================
cat > core/system_utils.py << 'EOF'
import os
import socket
...
# =======================================================
# 7. CREAR core/stl_utils.py
# =======================================================
cat > core/stl_utils.py << 'EOF'
import os
import struct
...
# =======================================================
# 10. CREAR ui/tabs/editor_tab.py
# =======================================================
cat > ui/tabs/editor_tab.py << 'EOF'
import flet as ft
...
# =======================================================
# 11. CREAR ui/tabs/constructor_tab.py
# =======================================================
cat > ui/tabs/constructor_tab.py << 'EOF'
import flet as ft
...
# =======================================================
# 12. CREAR ui/tabs/viewer_tab.py
# =======================================================
cat > ui/tabs/viewer_tab.py << 'EOF'
import flet as ft
from core.state import state
...
# =======================================================
# 13. CREAR ui/tabs/assembly_tab.py
# =======================================================
cat > ui/tabs/assembly_tab.py << 'EOF'
import flet as ft
...
# =======================================================
# 14. CREAR ui/tabs/pbr_tab.py
# =======================================================
cat > ui/tabs/pbr_tab.py << 'EOF'
import flet as ft
from core.state import state
...
# =======================================================
# 15. CREAR ui/tabs/files_tab.py
# =======================================================
cat > ui/tabs/files_tab.py << 'EOF'
import flet as ft
...
# =======================================================
# 16. CREAR ui/tabs/ai_tab.py
# =======================================================
cat > ui/tabs/ai_tab.py << 'EOF'
import flet as ft
from core.state import state
...
# =======================================================
# 17. CREAR ui/main_ui.py (ensamblador de UI)
# =======================================================
cat > ui/main_ui.py << 'EOF'
import flet as ft
...
echo "✅ Refactorización completada. Ejecuta 'python main.py' para probar."
